    ...
    protected function register_controls()
    {
        ...
        [
            ...
            'options' => [
                ...
                'spotlight_grid' => esc_html__('Spotlight Grid (1+2+4)', 'loop-mosaic'),
                'portrait_mosaic' => esc_html__('Portrait Mosaic (2+5)', 'loop-mosaic'),
                'editorial_spread' => esc_html__('Editorial Spread', 'loop-mosaic'),
                'sidebar_feature' => esc_html__('Sidebar Feature', 'loop-mosaic'),
                'windmill_corner' => esc_html__('Windmill Corner', 'loop-mosaic'),
                'filmstrip_break' => esc_html__('Filmstrip Break', 'loop-mosaic'),
                'staggered_columns' => esc_html__('Staggered Columns', 'loop-mosaic'),
                'overlapping_stack' => esc_html__('Overlapping Stack', 'loop-mosaic'),
            ],
            'default' => 'classic',
            'condition' => [
