...
(function ($) {
    ...
    const LoopMosaicFilters = {
         ...
         */
        init: function () {
            console.log('LoopMosaic: Filters Init Started');
            ...
            console.log('LoopMosaic: Filters Init Complete');
        },
        ...
        initJetSmartFilters: function () {
            if (typeof window.JetSmartFilters === 'undefined') {
                console.warn('LoopMosaic: window.JetSmartFilters is undefined');
            }

            const self = this;

            console.log('LoopMosaic: initJetSmartFilters checking settings...', {
            ...
            if (window.JetSmartFiltersSettings && window.JetSmartFiltersSettings.providers) {
                window.JetSmartFiltersSettings.providers['loop-mosaic'] = {
                    ...
                    apply: function (queryId, filters, pagination) {
                        console.log('LoopMosaic: Custom Apply Called for ' + queryId);
        ...
        applyFiltersAjax: function (queryId, filters, pagination) {
            ...
            console.log('LoopMosaic: Apply Filter', { queryId, filters, page, ajaxUrl });
            ...
            $.ajax({
                ...
                success: function (response) {
                    console.log('LoopMosaic: Filter Success', response);
                    ...
                    if (response.success && response.data) {
                        ...
                        console.error('LoopMosaic: Filter Response Error', response);
                    }
                ...
                error: function (xhr, status, error) {
                    $grid.removeClass('jet-filters-loading');
                    console.error('LoopMosaic: Filter Request Failed', { status, error, response: xhr.responseText });
                }
            });
        },
    ...
    $(window).on('elementor/frontend/init', function () {
        if (window.elementorFrontend && elementorFrontend.hooks) {
            elementorFrontend.hooks.addAction('frontend/element_ready/loopmosaic-grid.default', function ($scope) {
                console.log('LoopMosaic: Elementor Widget Ready Hook');
